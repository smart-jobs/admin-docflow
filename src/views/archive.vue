<template>
  <div class="lite">
    <data-grid :data="items" :action="true" :meta="fields" :operation="operation" @add-new="handleNew" @edit="handleEdit"
               @delete="handleDelete">
    </data-grid>
  </div>
</template>
