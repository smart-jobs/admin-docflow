<template>
  <div class="lite">
    <data-grid :data="items" :action="true" :meta="fields" :readonly="true" @add-new="handleNew" @edit="handleEdit"
               @delete="handleDelete">
...
export default {
  ...
  data() {
    return {
      ...
      form: {},
      passwdForm: {},
      fields: [{ name: 'unit', label: '单位' }, { name: 'name', label: '姓名' }, { name: 'mobile', label: '手机号' }, { name: 'email', label: '邮箱' }],
    };
  },
  methods: {
